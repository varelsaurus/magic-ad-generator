...
if st.button("Generate Magic! 🚀"):
    if not product_name or not vibe:
        st.warning("Isi dulu nama produk dan vibe-nya dong bos! 😅")
    else:
        try:
            # --- LANGKAH 1: PIKIRKAN IDE (TEXT GENERATION) ---
            with st.spinner("Sedang memeras otak cari ide caption... 🧠"):
            ...
            with st.spinner("Sedang melukis gambar produk... 🎨"):
